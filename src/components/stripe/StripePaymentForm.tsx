...
const CardForm = forwardRef<StripePaymentFormRef, PaymentFormProps>(({ 
  ...
  return (
    <div className="stripe-payment-form">
      {/* Display Stripe not loaded error */}
      {!stripe && (
        <div className="bg-red-50 border border-red-200 rounded-md p-4 mb-4">
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-red-800">Stripe Payment Not Available</h3>
              <div className="mt-2 text-sm text-red-700">
                <p>The payment system is not properly configured. Please contact support or try again later.</p>
                <p className="mt-1 text-xs">Error: Stripe publishable key is missing from environment variables.</p>
              </div>
            </div>
          </div>
        </div>
