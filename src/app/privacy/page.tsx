      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-6">
              At FreshCart, we are committed to protecting your privacy and ensuring the security 
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li><strong>Service Providers:</strong> Third-party companies that help us operate our business (payment processors, delivery services, email providers)</li>
